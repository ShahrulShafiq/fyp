...
<div class="row flex-lg-nowrap">
  ...
  <hr>
            ...
            $selectquery= "SELECT * FROM orders WHERE user_id = $userid AND status = 'Confirmed' ORDER BY 'orders','date' ASC";
  ...
  ?>
  <a href="orderitem.php?id=<?php echo $result['order_code'] ?>" style="text-decoration: none; color: black; ">
  <div class="row">
    <div class="col-2 text-info font-weight-bold">
     #<?php echo $result['order_code'] ?>
    </div>
      <div class="col-3">
      <small><?php echo $result['products'] ?></small>
    </div>
    <div class="col-2">
      <?php echo $newDate ?>
    </div>
