...
<div class="row">
    ...
    <div class="col-md-8 col-xl-9">
        <div class="card">
            ...
            <div class="card">
                ...
                <li class="nav-item"><a href="rating.php?id=<?php echo $result['id']; ?>" class="nav-link text-dark">Ratings & Feedback</a></li>
                <li class="nav-item"><a href="itembought.php?id=<?php echo $result['id']; ?>" class="active nav-link font-weight-bold">Item Purchased</a></li>
              </ul>
            ...
            $ambilvendor= "SELECT * FROM vendors where id=$id";
            $queryambilvendor = mysqli_query($con,$ambilvendor);
            $resultambilvendor = mysqli_fetch_assoc($queryambilvendor);

            $vendorname = $resultambilvendor['businessname'];
            $ambilitem= "SELECT * FROM sales WHERE user_id = '$userid' AND vendor_name = '$vendorname'";
            $querysales = mysqli_query($con,$ambilitem);


            while($salescolumn = mysqli_fetch_assoc($querysales)){

            $ordercode= $salescolumn['order_code'];
            $productcode= $salescolumn['product_code'];
            ...
            if($usercount<1){
            $feedbackornot = "<a href='givefeedback.php?id=$id&ordercode=$ordercode&productcode=$productcode'><span class='badge badge-success'>Give Feedback</span></a>";
            }else{
  ...
  ?>
            ...
            <div class="col-3"><img src="addtocart/image/<?php echo $salescolumn['product_image'] ?>" width="70px" height="50px"></div>
            <div class="col-3"><?php echo $salescolumn['product_name'] ?></div>
            <div class="col-3 text-primary font-weight-bold"><?php echo $newDate ?></div>
            <div class="col-3 text-center"><?php echo $feedbackornot ?></div>
            </div>
            <hr>
